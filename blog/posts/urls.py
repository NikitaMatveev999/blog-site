...
from .views import HomeView, PostDetailView, PostCreateView, PostDeleteView, PostUpdateView, add_like_view, \
    add_favourite_view, SearchResultsView, category_view, favourite_list, PostAPIView, RegistrationView
...
urlpatterns = [
    ...
    path('favourite/<int:pk>', add_favourite_view, name='favourite_post'),
